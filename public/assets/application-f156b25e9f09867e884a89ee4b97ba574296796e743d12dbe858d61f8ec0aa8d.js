      ...
      Notifications.prototype.handleSuccess = function(data) {
        ...
        items = $.map(data, function(notification) {
          if (notification.action === "messaged") {
            return "<div class='navbar-item'> <a href='" + notification.url + "'> A user has " + notification.action + " you!</a> </div>";
          } else if (/commented/.test(notification.action)) {
            return "<div class='navbar-item'> <a href='" + notification.url + "'>A user has " + notification.action + "</a> </div>";
